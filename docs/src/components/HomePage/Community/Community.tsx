...
import { Container, Group, Text, Title, usePatternTheme } from '@pattern-ui/core';
        ...
        <div className={classes.inner}>
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <Text sx={{ maxWidth: 600 }} className={classes.description}>
              Pattern has a very friendly community, we are always open to new ideas and feedback.
