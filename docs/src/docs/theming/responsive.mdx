...
import { MediaQueryDemos, CreateStylesDemos } from '@pattern/demos';

# Responsive styles

`@pattern/core` package exports several components that can help you organize responsive styles without writing CSS.
