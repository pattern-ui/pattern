...
1. Install `@pattern/ssr` package

```bash
yarn add @pattern/ssr

npm install @pattern/ssr
```

2. Create `App` component with `PatternProvider`
...
export function App() {
  return (
    {/* Setup PatternProvider with your theme */}
