---
group: 'pattern-labs'
package: '@pattern-ui/labs'
title: PinInput
slug: /labs/pin-input/
category: 'inputs'
description: 'Capture pin code from the user'
props: ['PinInput']
import: "import { PinInput } from '@pattern-ui/labs';"
source: 'pattern-labs/src/components/PinInput/PinInput.tsx'
docs: 'labs/PinInput.mdx'
styles: ['PinInput']
---

import { PinInputDemos } from '@pattern-ui/demos';
...
You can control input format with `type` prop. Pattern provides 2
...
```tsx
import { PinInput } from '@pattern-ui/core';
