...
release: https://github.com/pattern-ui/pattern/releases/tag/5.0.0
date: 'March 29th, 2022'
---

import { TabsDemos, AccordionDemos, TooltipDemos, PopoverDemos } from '@pattern-ui/demos';

## Components API changes

### Tabs component

[Tabs](https://pattern-ui.design/core/tabs/) and associated [Prism.Tabs](https://pattern-ui.design/others/prism/) components now have new API.
...
<ControlDemo data={TabsDemos.control} />

### Accordion component

[Accordion](https://pattern-ui.design/core/accordion/) component now has new API with the following new props:
...
<ControlDemo data={AccordionDemos.control} />

### Tooltip component

[Tooltip](https://pattern-ui.design/core/tooltip/) now requires children to be an element or a component,
...
```tsx
import { Tooltip, Badge } from '@pattern-ui/core';
...
function Demo() {
  return (
    <>
      ...
      <Tooltip label="OK">
        <Badge>Pattern component – ok</Badge>
      </Tooltip>
...
[Popover](https://pattern-ui.design/core/popover/) component now has new API with the following breaking changes:
...
- [Portal](https://pattern-ui.design/core/portal/) component no longer accepts `position` and `zIndex` props – it is now required to add these styles to Portal children
- FloatingTooltip component was renamed to [Tooltip.Floating](https://pattern-ui.design/core/tooltip/#floating-tooltip)
...
[Tooltip.Group](https://pattern-ui.design/core/tooltip/#tooltip-delay-group) component can be used to sync open and close delays for multiple tooltips:

<Demo data={TooltipDemos.group} />

## Other changes

- New [FocusTrap](https://pattern-ui.design/core/focus-trap/) component – component implementation of [use-focus-trap](https://pattern-ui.design/hooks/use-focus-trap/) hook
