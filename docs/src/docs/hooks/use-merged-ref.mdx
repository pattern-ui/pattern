...
import: "import { useMergedRef } from '@pattern-ui/hooks';"
docs: 'hooks/use-merged-ref.mdx'
source: 'pattern-hooks/src/use-merged-ref/use-merged-ref.ts'
---
...
```tsx
import { useRef } from 'react';
import { useClickOutside, mergeRefs } from '@pattern-ui/hooks';
