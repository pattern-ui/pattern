...
import: "import { useFocusReturn } from '@pattern-ui/hooks';"
docs: 'hooks/use-focus-return.mdx'
source: 'pattern-hooks/src/use-focus-return/use-focus-return.ts'
---

import { ModalDemos } from '@pattern-ui/demos';
