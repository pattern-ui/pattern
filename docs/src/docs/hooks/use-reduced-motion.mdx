...
import: "import { useReducedMotion } from '@pattern-ui/hooks';"
docs: 'hooks/use-reduced-motion.mdx'
source: 'pattern-hooks/src/use-reduced-motion/use-reduced-motion.ts'
---
...
All Pattern components which use animations support it by default:
