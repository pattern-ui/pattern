...
import: "import { useId } from '@pattern-ui/hooks';"
docs: 'hooks/use-id.mdx'
source: 'pattern-hooks/src/use-id/use-id.ts'
---
...
```tsx
import { useId } from '@pattern-ui/hooks';
...
// input and label will have random id 'pattern-fZMoF'
