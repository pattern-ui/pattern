...
import: "import { useFocusTrap } from '@pattern/hooks';"
docs: 'hooks/use-focus-trap.mdx'
source: 'pattern-hooks/src/use-focus-trap/use-focus-trap.ts'
---

import { ModalDemos, MenuDemos } from '@pattern/demos';
...
```tsx
import { useFocusTrap } from '@pattern/hooks';
...
import { useClickOutside, useFocusTrap, useMergedRef } from '@pattern/hooks';
