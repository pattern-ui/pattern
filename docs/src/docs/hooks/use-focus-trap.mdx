...
import: "import { useFocusTrap } from '@pattern-ui/hooks';"
docs: 'hooks/use-focus-trap.mdx'
source: 'pattern-hooks/src/use-focus-trap/use-focus-trap.ts'
---

import { ModalDemos, MenuDemos } from '@pattern-ui/demos';
...
```tsx
import { useFocusTrap } from '@pattern-ui/hooks';
...
import { useClickOutside, useFocusTrap, useMergedRef } from '@pattern-ui/hooks';
...
use-focus-trap is used in some Pattern components: [Modal](/core/modal/), [Drawer](/core/drawer/), [Menu](/core/menu/) and others.
