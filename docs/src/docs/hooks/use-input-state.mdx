...
import: "import { useInputState } from '@pattern-ui/hooks';"
docs: 'hooks/use-input-state.mdx'
source: 'pattern-hooks/src/use-input-state/use-input-state.ts'
---
...
Hook works with all Pattern and native inputs:
