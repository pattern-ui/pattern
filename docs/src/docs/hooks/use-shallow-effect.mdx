...
import: "import { useShallowEffect } from '@pattern-ui/hooks';"
docs: 'hooks/use-shallow-effect.mdx'
source: 'pattern-hooks/src/use-shallow-effect/use-shallow-effect.ts'
---
...
import { useShallowEffect } from '@pattern-ui/hooks';
