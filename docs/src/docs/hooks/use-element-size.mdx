...
import: "import { useElementSize } from '@pattern-ui/hooks';"
...
use-element-size is a simpler version of [use-resize-observer](https://pattern-ui.design/hooks/use-resize-observer/) hook.
