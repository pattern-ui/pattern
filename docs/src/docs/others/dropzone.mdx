...
import: "import { Dropzone, FullScreenDropzone } from '@pattern-ui/dropzone';"
source: 'pattern-dropzone/src'
docs: 'others/dropzone.mdx'
installation: '@pattern-ui/dropzone'
license: MIT
...
} from '@pattern-ui/dropzone';
import { DropzoneDemos } from '@pattern-ui/demos';
...
```tsx
import { Dropzone } from '@pattern-ui/dropzone';
...
To save some research time you can use `MIME_TYPES` variable exported from `@pattern-ui/dropzone`:

```tsx
import { Dropzone, MIME_TYPES } from '@pattern-ui/dropzone';
...
```tsx
import { IMAGE_MIME_TYPE, Dropzone } from '@pattern-ui/dropzone';
