...
source: 'pattern-notifications/src'
docs: 'others/notifications.mdx'
pageTitle: 'Pattern Notifications'
description: 'Pattern notifications system'
installation: '@pattern-ui/notifications'
license: MIT
---

import { NotificationDemos, NotificationsDemos } from '@pattern-ui/demos';
...
```sh
npm install @pattern-ui/notifications @pattern-ui/core @pattern-ui/hooks
```

Install with yarn:

```sh
yarn add @pattern-ui/notifications @pattern-ui/core @pattern-ui/hooks
```
...
`@pattern-ui/notifications` package exports the following functions:
...
All functions can be imported from `@pattern-ui/notifications` package and can be used in any part of your application:
...
```tsx
import { showNotification, hideNotification } from '@pattern-ui/notifications';
