...
import: "import { SpotlightProvider } from '@pattern/spotlight';"
source: 'pattern-spotlight/src'
docs: 'others/spotlight.mdx'
installation: '@pattern/spotlight'
license: MIT
styles: ['SpotlightProvider']
---

import { SpotlightDemos } from '@pattern/demos';
...
`@pattern/spotlight` exports several functions which can be used to perform certain actions
...
You can import `SpotlightAction` type from `@pattern/spotlight` package:
