...
import: "import { RichTextEditor } from '@pattern/rte';"
source: 'pattern-rte/src'
docs: 'others/rte.mdx'
installation: '@pattern/rte'
license: MIT
...
Package has peer dependencies: [react](https://www.npmjs.com/package/react), [react-dom](https://www.npmjs.com/package/react-dom), [@pattern/hooks](https://www.npmjs.com/package/@pattern/hooks) and [@pattern/core](https://www.npmjs.com/package/@pattern/core):.

Install with npm:

```sh
npm install @pattern/rte @pattern/core @pattern/hooks
```

Install with yarn:

```sh
yarn add @pattern/rte @pattern/core @pattern/hooks
```
...
import { RichTextEditor, Editor } from '@pattern/rte';
...
export default dynamic(() => import('@pattern/rte'), {
