...
import: "import { RichTextEditor } from '@pattern-ui/rte';"
source: 'pattern-rte/src'
docs: 'others/rte.mdx'
installation: '@pattern-ui/rte'
license: MIT
...
Package has peer dependencies: [react](https://www.npmjs.com/package/react), [react-dom](https://www.npmjs.com/package/react-dom), [@pattern-ui/hooks](https://www.npmjs.com/package/@pattern-ui/hooks) and [@pattern-ui/core](https://www.npmjs.com/package/@pattern-ui/core):.

Install with npm:

```sh
npm install @pattern-ui/rte @pattern-ui/core @pattern-ui/hooks
```

Install with yarn:

```sh
yarn add @pattern-ui/rte @pattern-ui/core @pattern-ui/hooks
```
...
- `stickyOffset` – top property, used with sticky position, use it to offset elements with fixed position, for example, Pattern docs website has 60px header, in this case you should set stickyOffset to 60
...
import { RichTextEditor } from '@pattern-ui/rte';
...
import { RichTextEditor, Editor } from '@pattern-ui/rte';
...
export default dynamic(() => import('@pattern-ui/rte'), {
