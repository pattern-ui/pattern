...
import: "import { TimeInput, TimeRangeInput } from '@pattern-ui/dates';"
source: 'pattern-dates/src/components/TimeInput/TimeInput.tsx'
docs: 'dates/TimeInput.mdx'
styles: ['TimeInput', 'TimeRangeInput']
---

import { TimeInputDemos, TimeRangeInputDemos } from '@pattern-ui/demos';
...
<ControlDemo data={TimeInputDemos.control} />
