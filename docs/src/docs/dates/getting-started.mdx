...
- [@pattern-ui/hooks](https://www.npmjs.com/package/@pattern-ui/hooks)
- [@pattern-ui/core](https://www.npmjs.com/package/@pattern-ui/core)

Install with npm:

```sh
npm install dayjs @pattern-ui/core @pattern-ui/hooks @pattern-ui/dates
```

Install with yarn:

```sh
yarn add dayjs @pattern-ui/core @pattern-ui/hooks @pattern-ui/dates
```

## Localization

Pattern dates uses [dayjs](https://day.js.org/) library for localization.
...
[PatternProvider](/theming/pattern-provider/) allows you to set a `datesLocale` property for all date components, or you can overwrite the locale on a per component basis:

```tsx
import { DatePicker, Calendar, Month } from '@pattern-ui/dates';
...
Apart from components @pattern-ui/dates package also exports several utility functions.
...
```tsx
import { getMonthDays } from '@pattern-ui/dates';
...
```tsx
import { getMonthsNames } from '@pattern-ui/dates';
...
```tsx
import { getWeekdaysNames } from '@pattern-ui/dates';
...
```tsx
import { getYearsRange } from '@pattern-ui/dates';
...
```tsx
import { isSameDate } from '@pattern-ui/dates';
...
```tsx
import { isSameMonth } from '@pattern-ui/dates';
