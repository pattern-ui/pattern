...
- [@pattern/hooks](https://www.npmjs.com/package/@pattern/hooks)
- [@pattern/core](https://www.npmjs.com/package/@pattern/core)

Install with npm:

```sh
npm install dayjs @pattern/core @pattern/hooks @pattern/dates
```

Install with yarn:

```sh
yarn add dayjs @pattern/core @pattern/hooks @pattern/dates
```
...
```tsx
import { DatePicker, Calendar, Month } from '@pattern/dates';
...
Apart from components @pattern/dates package also exports several utility functions.
...
```tsx
import { getMonthDays } from '@pattern/dates';
...
```tsx
import { getMonthsNames } from '@pattern/dates';
...
```tsx
import { getWeekdaysNames } from '@pattern/dates';
...
```tsx
import { getYearsRange } from '@pattern/dates';
...
```tsx
import { isSameDate } from '@pattern/dates';
...
```tsx
import { isSameMonth } from '@pattern/dates';
