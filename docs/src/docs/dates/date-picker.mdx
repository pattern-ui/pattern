...
import: "import { DatePicker, DateRangePicker } from '@pattern-ui/dates';"
source: 'pattern-dates/src/components/DatePicker/DatePicker.tsx'
docs: 'dates/DatePicker.mdx'
styles: ['DatePicker', 'DateRangePicker']
---

import { DatePickerDemos, DateRangePickerDemos } from '@pattern-ui/demos';
...
<ControlDemo data={DatePickerDemos.control} />
