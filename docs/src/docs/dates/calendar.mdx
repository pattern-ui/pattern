...
import: "import { Calendar, RangeCalendar } from '@pattern-ui/dates';"
source: 'pattern-dates/src/components/Calendar/Calendar.tsx'
docs: 'dates/Calendar.mdx'
styles: ['Calendar', 'RangeCalendar']
---

import { CalendarDemos, RangeCalendarDemos } from '@pattern-ui/demos';
