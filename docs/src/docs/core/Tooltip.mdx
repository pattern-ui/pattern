...
import: "import { Tooltip } from '@pattern-ui/core';"
source: 'pattern-core/src/components/Tooltip/Tooltip.tsx'
docs: 'core/Tooltip.mdx'
styles: ['Tooltip']
---

import { TooltipDemos } from '@pattern-ui/demos';
...
<ControlDemo data={TooltipDemos.control} />
