...
props: ['TransferList']
import: "import { TransferList } from '@pattern-ui/core';"
source: 'pattern-core/src/components/TransferList/TransferList.tsx'
docs: 'core/TransferList.mdx'
styles: ['TransferList']
---

import { TransferListDemos } from '@pattern-ui/demos';
