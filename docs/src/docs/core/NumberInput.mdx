...
props: ['NumberInput']
import: "import { NumberInput } from '@pattern-ui/core';"
source: 'pattern-core/src/components/NumberInput/NumberInput.tsx'
docs: 'core/NumberInput.mdx'
styles: ['NumberInput']
---

import { NumberInputDemos } from '@pattern-ui/demos';

## Usage

<ControlDemo data={NumberInputDemos.control} />
