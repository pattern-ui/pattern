...
props: ['Menu']
import: "import { Menu } from '@pattern-ui/core';"
source: 'pattern-core/src/components/Menu/Menu.tsx'
docs: 'core/Menu.mdx'
styles: ['Menu']
---

import { MenuDemos } from '@pattern-ui/demos';
...
```tsx
import { Menu, Text } from '@pattern-ui/core';
...
<ControlDemo data={MenuDemos.positionControl} />
...
<ControlDemo data={MenuDemos.control} />
...
<Menu.Item component="a" href="https://pattern/dev" target="_blank" />
...
```tsx
import { Menu } from '@pattern-ui/core';
import { NextLink } from '@pattern-ui/next';
