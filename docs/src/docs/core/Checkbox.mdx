...
props: ['Checkbox']
import: "import { Checkbox } from '@pattern-ui/core';"
source: 'pattern-core/src/components/Checkbox/Checkbox.tsx'
docs: 'core/Checkbox.mdx'
styles: ['Checkbox']
---

import { CheckboxDemos } from '@pattern-ui/demos';

## Usage

<ControlDemo data={CheckboxDemos.control} />
