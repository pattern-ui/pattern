...
import: "import { Tabs } from '@pattern-ui/core';"
source: 'pattern-core/src/components/Tabs/Tabs.tsx'
docs: 'core/Tabs.mdx'
styles: ['Tabs']
---

import { TabsDemos } from '@pattern-ui/demos';
...
<ControlDemo data={TabsDemos.positionControl} />
