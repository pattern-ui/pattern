...
props: ['Spoiler']
import: "import { Spoiler } from '@pattern-ui/core';"
source: 'pattern-core/src/components/Spoiler/Spoiler.tsx'
docs: 'core/Spoiler.mdx'
styles: ['Spoiler']
---

import { SpoilerDemos } from '@pattern-ui/demos';
...
import { Spoiler } from '@pattern-ui/core';
