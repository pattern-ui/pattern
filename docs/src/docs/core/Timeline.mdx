...
import: "import { Timeline } from '@pattern-ui/core';"
source: 'pattern-core/src/components/Timeline/Timeline.tsx'
docs: 'core/Timeline.mdx'
styles: ['Timeline']
---

import { TimelineDemos } from '@pattern-ui/demos';
...
<ControlDemo data={TimelineDemos.control} />
