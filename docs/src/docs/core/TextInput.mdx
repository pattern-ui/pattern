...
props: ['TextInput']
import: "import { TextInput } from '@pattern-ui/core';"
source: 'pattern-core/src/components/TextInput/TextInput.tsx'
docs: 'core/TextInput.mdx'
styles: ['TextInput']
---

import { TextInputDemos } from '@pattern-ui/demos';

## Usage

<ControlDemo data={TextInputDemos.control} />
