...
props: ['PasswordInput']
import: "import { PasswordInput } from '@pattern-ui/core';"
source: 'pattern-core/src/components/PasswordInput/PasswordInput.tsx'
docs: 'core/PasswordInput.mdx'
styles: ['PasswordInput']
---

import { PasswordInputDemos } from '@pattern-ui/demos';
...
<ControlDemo data={PasswordInputDemos.control} />
