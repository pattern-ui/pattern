...
props: ['JsonInput']
import: "import { JsonInput } from '@pattern-ui/core';"
source: 'pattern-core/src/components/JsonInput/JsonInput.tsx'
docs: 'core/JsonInput.mdx'
styles: ['JsonInput']
---

import { JsonInputDemos } from '@pattern-ui/demos';
...
<ControlDemo data={JsonInputDemos.control} />
