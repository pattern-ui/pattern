...
props: ['Popper']
import: "import { Popper } from '@pattern-ui/core';"
source: 'pattern-core/src/components/Popper/Popper.tsx'
docs: 'core/Popper.mdx'
---

import { PopperDemos, TooltipDemos } from '@pattern-ui/demos';

## Usage

Popper is a utility component used under the hood in [Menu](/core/menu/), [Progress](/core/popover/), [Tooltip](/core/tooltip/)
and other Pattern components. You can use it to create your own dropdowns and popovers if Pattern components do not meet your requirements.
...
import { Popper } from '@pattern-ui/core';
