...
props: ['Transition']
import: "import { Transition, GroupedTransition } from '@pattern/core';"
source: 'pattern-core/src/components/Transition/Transition.tsx'
docs: 'core/Transition.mdx'
---

import { TooltipDemos, TransitionDemos } from '@pattern/demos';
...
```tsx
import { Transition } from '@pattern/core';
...
```tsx
import { GroupedTransition } from '@pattern/core';
