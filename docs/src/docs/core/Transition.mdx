...
props: ['Transition']
import: "import { Transition, GroupedTransition } from '@pattern-ui/core';"
source: 'pattern-core/src/components/Transition/Transition.tsx'
docs: 'core/Transition.mdx'
---

import { TooltipDemos, TransitionDemos } from '@pattern-ui/demos';
...
Pattern includes several premade transitions:
...
```tsx
import { Transition } from '@pattern-ui/core';
...
```tsx
import { GroupedTransition } from '@pattern-ui/core';
