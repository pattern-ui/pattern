...
props: ['Notification']
import: "import { Notification } from '@pattern/core';"
source: 'pattern-core/src/components/Notification/Notification.tsx'
docs: 'core/Notification.mdx'
styles: ['Notification']
---

import { NotificationDemos } from '@pattern/demos';

## Usage

Notification is a base component for notification system.
Build your own or use [@pattern/notifications](/others/notifications/) package.
