...
props: ['Notification']
import: "import { Notification } from '@pattern-ui/core';"
source: 'pattern-core/src/components/Notification/Notification.tsx'
docs: 'core/Notification.mdx'
styles: ['Notification']
---

import { NotificationDemos } from '@pattern-ui/demos';

## Usage

Notification is a base component for notification system.
Build your own or use [@pattern-ui/notifications](/others/notifications/) package.
...
<ControlDemo data={NotificationDemos.control} />
