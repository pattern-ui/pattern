...
props: ['ColorSwatch']
import: "import { ColorSwatch } from '@pattern-ui/core';"
source: 'pattern-core/src/components/ColorSwatch/ColorSwatch.tsx'
docs: 'core/ColorSwatch.mdx'
styles: ['ColorSwatch', 'single-node']
---

import { ColorSwatchDemos } from '@pattern-ui/demos';
