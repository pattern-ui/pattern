...
import: "import { SegmentedControl } from '@pattern-ui/core';"
source: 'pattern-core/src/components/SegmentedControl/SegmentedControl.tsx'
docs: 'core/SegmentedControl.mdx'
styles: ['SegmentedControl']
---

import { SegmentedControlDemos } from '@pattern-ui/demos';
...
<ControlDemo data={SegmentedControlDemos.control} />
