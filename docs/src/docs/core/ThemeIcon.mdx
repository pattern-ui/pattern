...
props: ['ThemeIcon']
import: "import { ThemeIcon } from '@pattern-ui/core';"
source: 'pattern-core/src/components/ThemeIcon/ThemeIcon.tsx'
docs: 'core/ThemeIcon.mdx'
styles: ['ThemeIcon', 'single-node']
---

import { ThemeIconDemos } from '@pattern-ui/demos';

## Usage

<ControlDemo data={ThemeIconDemos.control} />
