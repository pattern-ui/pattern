...
props: ['MediaQuery']
import: "import { MediaQuery } from '@pattern-ui/core';"
source: 'pattern-core/src/components/MediaQuery/MediaQuery.tsx'
docs: 'core/MediaQuery.mdx'
styles: ['MediaQuery', 'single-node']
---

import { DEFAULT_THEME } from '@pattern-ui/core';
import { MediaQueryDemos } from '@pattern-ui/demos';
...
To change these values wrap your application with PatternProvider and set `breakpoints` prop on theme:
...
import { MediaQuery } from '@pattern-ui/core';
