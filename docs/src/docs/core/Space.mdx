...
props: ['Space']
import: "import { Space } from '@pattern-ui/core';"
source: 'pattern-core/src/components/Space/Space.tsx'
docs: 'core/Space.mdx'
styles: ['Space', 'single-node']
---

import { SpaceDemos } from '@pattern-ui/demos';
...
In most cases, you would want to use margin props instead of Space when working with Pattern components:
