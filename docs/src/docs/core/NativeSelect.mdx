...
props: ['NativeSelect']
import: "import { NativeSelect } from '@pattern-ui/core';"
source: 'pattern-core/src/components/NativeSelect/NativeSelect.tsx'
docs: 'core/NativeSelect.mdx'
styles: ['NativeSelect']
---

import { NativeSelectDemos } from '@pattern-ui/demos';

## Usage

<ControlDemo data={NativeSelectDemos.control} />
