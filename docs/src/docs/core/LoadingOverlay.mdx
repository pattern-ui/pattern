...
import: "import { LoadingOverlay } from '@pattern-ui/core';"
source: 'pattern-core/src/components/LoadingOverlay/LoadingOverlay.tsx'
docs: 'core/LoadingOverlay.mdx'
styles: ['LoadingOverlay', 'single-node']
---

import { LoadingOverlayDemos } from '@pattern-ui/demos';
...
```tsx
import { LoadingOverlay } from '@pattern-ui/core';
