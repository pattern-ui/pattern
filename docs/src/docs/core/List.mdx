...
props: ['List']
import: "import { List } from '@pattern-ui/core';"
source: 'pattern-core/src/components/List/List.tsx'
docs: 'core/List.mdx'
styles: ['List']
---

import { ListDemos } from '@pattern-ui/demos';

## Usage

<ControlDemo data={ListDemos.control} />
