...
props: ['Highlight']
import: "import { Highlight } from '@pattern-ui/core';"
source: 'pattern-core/src/components/Highlight/Highlight.tsx'
docs: 'core/Highlight.mdx'
styles: ['Highlight', 'single-node']
---

import { HighlightDemos } from '@pattern-ui/demos';
...
<ControlDemo data={HighlightDemos.control} />
