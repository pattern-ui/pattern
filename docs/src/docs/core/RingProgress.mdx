...
props: ['RingProgress']
import: "import { RingProgress } from '@pattern-ui/core';"
source: 'pattern-core/src/components/RingProgress/RingProgress.tsx'
docs: 'core/RingProgress.mdx'
styles: ['RingProgress']
---

import { RingProgressDemos } from '@pattern-ui/demos';
