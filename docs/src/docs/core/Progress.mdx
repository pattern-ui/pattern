...
props: ['Progress']
import: "import { Progress } from '@pattern-ui/core';"
source: 'pattern-core/src/components/Progress/Progress.tsx'
docs: 'core/Progress.mdx'
styles: ['Progress']
---

import { ProgressDemos, PasswordInputDemos } from '@pattern-ui/demos';
...
<ControlDemo data={ProgressDemos.control} />
