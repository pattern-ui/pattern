...
props: ['Select']
import: "import { Select } from '@pattern-ui/core';"
source: 'pattern-core/src/components/Select/Select.tsx'
docs: 'core/Select.mdx'
styles: ['Select']
---

import { SelectDemos } from '@pattern-ui/demos';
...
<ControlDemo data={SelectDemos.control} />
