...
import: "import { Popover } from '@pattern-ui/core';"
source: 'pattern-core/src/components/Popover/Popover.tsx'
docs: 'core/Popover.mdx'
styles: ['Popover']
---

import { PopoverDemos, PasswordInputDemos } from '@pattern-ui/demos';
...
import { Popover, Button } from '@pattern-ui/core';
...
all Pattern components support ref out of the box.

```tsx
import { Popover, Badge } from '@pattern-ui/core';
