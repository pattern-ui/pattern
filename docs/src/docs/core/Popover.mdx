...
import: "import { Popover } from '@pattern/core';"
source: 'pattern-core/src/components/Popover/Popover.tsx'
docs: 'core/Popover.mdx'
styles: ['Popover']
---

import { PopoverDemos, PasswordInputDemos } from '@pattern/demos';
...
import { Popover, Button } from '@pattern/core';
...
```tsx
import { Popover, Badge } from '@pattern/core';
