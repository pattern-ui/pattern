...
props: ['MultiSelect']
import: "import { MultiSelect } from '@pattern-ui/core';"
source: 'pattern-core/src/components/MultiSelect/MultiSelect.tsx'
docs: 'core/MultiSelect.mdx'
styles: ['MultiSelect']
---

import { MultiSelectDemos } from '@pattern-ui/demos';
...
<ControlDemo data={MultiSelectDemos.control} />
