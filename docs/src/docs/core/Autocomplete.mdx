...
props: ['Autocomplete']
import: "import { Autocomplete } from '@pattern-ui/core';"
source: 'pattern-core/src/components/Autocomplete/Autocomplete.tsx'
docs: 'core/Autocomplete.mdx'
styles: ['Autocomplete']
---

import { AutocompleteDemos } from '@pattern-ui/demos';
...
<ControlDemo data={AutocompleteDemos.control} />
