...
props: ['Pagination']
import: "import { Pagination } from '@pattern-ui/core';"
source: 'pattern-core/src/components/Pagination/Pagination.tsx'
docs: 'core/Pagination.mdx'
styles: ['Pagination']
---

import { PaginationDemos } from '@pattern-ui/demos';
...
If you need more flexibility @pattern-ui/hooks exports [use-pagination](/hooks/use-pagination/) hook,
