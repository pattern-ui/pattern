...
props: ['Paper']
import: "import { Paper } from '@pattern-ui/core';"
source: 'pattern-core/src/components/Paper/Paper.tsx'
docs: 'core/Paper.mdx'
styles: ['Paper', 'single-node']
---

import { PaperDemos } from '@pattern-ui/demos';
...
<ControlDemo data={PaperDemos.control} />
...
import { Paper } from '@pattern-ui/core';
