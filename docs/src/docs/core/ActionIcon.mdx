...
props: ['ActionIcon']
import: "import { ActionIcon } from '@pattern-ui/core';"
source: 'pattern-core/src/components/ActionIcon/ActionIcon.tsx'
docs: 'core/ActionIcon.mdx'
styles: ['ActionIcon']
---

import { ActionIconDemos } from '@pattern-ui/demos';

## Usage

<ControlDemo data={ActionIconDemos.control} />
