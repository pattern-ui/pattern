...
props: ['ColorPicker']
import: "import { ColorPicker } from '@pattern-ui/core';"
source: 'pattern-core/src/components/ColorPicker/ColorPicker.tsx'
docs: 'core/ColorPicker.mdx'
styles: ['ColorPicker']
---

import { ColorPickerDemos } from '@pattern-ui/demos';
...
<ControlDemo data={ColorPickerDemos.formatsControl} />
...
<ControlDemo data={ColorPickerDemos.swatchesControl} />
...
<ControlDemo data={ColorPickerDemos.sizeControl} />

## AlphaSlider

You can import and use AlphaSlider and HueSlider components outside of ColorPicker:

<ControlDemo data={ColorPickerDemos.alphaControl} />

## HueSlider

<ControlDemo data={ColorPickerDemos.hueControl} />
