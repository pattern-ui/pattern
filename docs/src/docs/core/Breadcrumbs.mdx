...
props: ['Breadcrumbs']
import: "import { Breadcrumbs } from '@pattern-ui/core';"
source: 'pattern-core/src/components/Breadcrumbs/Breadcrumbs.tsx'
docs: 'core/Breadcrumbs.mdx'
styles: ['Breadcrumbs']
---

import { BreadcrumbsDemos } from '@pattern-ui/demos';
