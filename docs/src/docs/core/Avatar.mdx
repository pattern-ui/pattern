...
import: "import { Avatar, AvatarsGroup } from '@pattern-ui/core';"
source: 'pattern-core/src/components/Avatar/Avatar.tsx'
docs: 'core/Avatar.mdx'
styles: ['Avatar', 'AvatarsGroup']
---

import { AvatarDemos } from '@pattern-ui/demos';
...
<ControlDemo data={AvatarDemos.control} />
...
import { Card } from '@pattern-ui/core';
