...
import: "import { Slider, RangeSlider } from '@pattern-ui/core';"
source: 'pattern-core/src/components/Slider'
docs: 'core/Slider.mdx'
styles: ['Slider', 'RangeSlider']
---

import { SliderDemos } from '@pattern-ui/demos';

## Usage

<ControlDemo data={SliderDemos.control} />
