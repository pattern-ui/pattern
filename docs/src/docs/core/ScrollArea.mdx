...
props: ['ScrollArea']
styles: ['ScrollArea']
import: "import { ScrollArea } from '@pattern-ui/core';"
source: 'pattern-core/src/components/ScrollArea/ScrollArea.tsx'
docs: 'core/ScrollArea.mdx'
---

import { AppShellDemos, ScrollAreaDemos } from '@pattern-ui/demos';
...
<ControlDemo data={ScrollAreaDemos.control} />
...
ScrollArea integrates seamlessly with all Pattern components that can require scrollbars.
