...
props: ['Stepper', 'Step']
import: "import { Stepper, Step } from '@pattern-ui/core';"
source: 'pattern-core/src/components/Stepper/Stepper.tsx'
docs: 'core/Stepper.mdx'
styles: ['Stepper']
---

import { StepperDemos } from '@pattern-ui/demos';
...
<ControlDemo data={StepperDemos.control} />
...
<ControlDemo data={StepperDemos.iconSizeControl} />
...
You can [configure breakpoints](/theming/extend-theme/#breakpoints) in PatternProvider or use
...
Loader will replace step icon. You can configure default loader in [PatternProvider](/theming/pattern-provider/).
