...
slug: /core/button/
category: 'inputs'
description: 'Render button or link with button styles from pattern theme'
props: ['Button']
import: "import { Button } from '@pattern-ui/core';"
source: 'pattern-core/src/components/Button/Button.tsx'
docs: 'core/Button.mdx'
styles: ['Button']
---

import { ButtonDemos } from '@pattern-ui/demos';

## Usage

<ControlDemo data={ButtonDemos.control} />
...
<ControlDemo data={ButtonDemos.whiteControl} />
...
it renders regular button without default browser styles and with Pattern focus styles:
