...
props: ['ColorInput']
import: "import { ColorInput } from '@pattern-ui/core';"
source: 'pattern-core/src/components/ColorInput/ColorInput.tsx'
docs: 'core/ColorInput.mdx'
styles: ['ColorInput']
---

import { ColorInputDemos, ColorPickerDemos } from '@pattern-ui/demos';
...
<ControlDemo data={ColorInputDemos.formatsControl} />
...
<ControlDemo data={ColorInputDemos.inputControl} />
