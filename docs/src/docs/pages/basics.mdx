...
- [Join the Discord community](https://discord.gg/comingsoon) – it is the easiest way to get help, all questions are usually answered in about 30 minutes.
...
function Demo() {
  return (
    <>
      {/* with html element */}
      <Text component="a" href="https://pattern.icu">
        My link text
      </Text>
...
function Demo() {
  return (
    <>
      ...
      <Text<'a'> component="a" href="https://pattern.icu">
        Pattern website
      </Text>
