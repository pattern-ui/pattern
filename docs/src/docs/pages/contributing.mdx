...
- **Give feedback:** we are constantly working on making Pattern better, please share how you use Pattern, what features are missing and what is done good via [GitHub Discussions](https://github.com/pattern-ui/pattern/discussions/new) or [Discord](https://discord.gg/comingsoon)
...
- If you want to implement new feature discuss it with maintainer ([GitHub Discussions](https://github.com/pattern-ui/pattern/discussions/new) or [Discord](https://discord.gg/comingsoon)) before jumping into code
