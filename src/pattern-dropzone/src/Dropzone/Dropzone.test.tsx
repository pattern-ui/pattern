...
describe('@pattern/dropzone/Dropzone', () => {
  ...
  it('displays LoadingOverlay based on loading prop', () => {
    ...
    expect(loading.querySelectorAll('.pattern-LoadingOverlay-root')).toHaveLength(1);
    expect(notLoading.querySelectorAll('.pattern-LoadingOverlay-root')).toHaveLength(0);
  });
