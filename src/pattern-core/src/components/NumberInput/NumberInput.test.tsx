...
const getRightSection = (container: HTMLElement) =>
  container.querySelector('.pattern-NumberInput-rightSection');

const clickIncrement = (container: HTMLElement) =>
  userEvent.click(container.querySelector('.pattern-NumberInput-controlUp'));

const clickDecrement = (container: HTMLElement) =>
  userEvent.click(container.querySelector('.pattern-NumberInput-controlDown'));
