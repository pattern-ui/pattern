...
describe('@pattern/dates/MonthsList', () => {
  ...
  it('calls onNextLevel when level label is clicked', () => {
    ...
    userEvent.click(container.querySelector('.pattern-MonthsList-calendarHeaderLevel'));
  ...
  it('renders correct amount of months', () => {
    ...
    expect(two.querySelectorAll('.pattern-MonthsList-month')).toHaveLength(2);
    expect(three.querySelectorAll('.pattern-MonthsList-month')).toHaveLength(3);
    expect(four.querySelectorAll('.pattern-MonthsList-month')).toHaveLength(4);
  });
