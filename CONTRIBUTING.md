...
- `[@pattern/core] Button: Add theme focus styles` – Change in `@pattern/core` package at Button component
- `[@pattern/hooks] use-list-state: Add remove handler` – Change in `@pattern/hooks` package at use-list-state hook
