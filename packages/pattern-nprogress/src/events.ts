...
export const NPROGRESS_EVENTS = {
  add: 'pattern:add-nprogress',
  decrease: 'pattern:decrease-nprogress',
  set: 'pattern:set-nprogress',
  start: 'pattern:start-nprogress',
  stop: 'pattern:stop-nprogress',
  reset: 'pattern:reset-nprogress',
} as const;
