import { OptionalPortal, Progress } from '@pattern/core';
import { useDidUpdate, useInterval, useReducedMotion } from '@pattern/hooks';
import { getDefaultZIndex, PatternColor } from '@pattern/styles';
