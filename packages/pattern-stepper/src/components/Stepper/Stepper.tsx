...
import { findChildByType, filterChildrenByType } from '@pattern-ui/utils';
...
export interface StepperProps
  ...
  contentPadding?: PatternNumberSize;
...
export const Stepper: StepperComponent = forwardRef<HTMLDivElement, StepperProps>(
  (props: StepperProps, ref) => {
    const {
      ...
      styles,
      ...others
    } = usePatternDefaultProps('Stepper', defaultProps, props);
