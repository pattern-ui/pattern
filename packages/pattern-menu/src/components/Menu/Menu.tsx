...
import { Popper, SharedPopperProps } from '@pattern-ui/popper';
...
export const Menu: MenuComponent = forwardRef<HTMLButtonElement, MenuProps>(
  (props: MenuProps, ref) => {
    const {
      ...
      clickOutsideEvents,
      ...others
    } = usePatternDefaultProps('Menu', defaultProps, props);
    ...
    const handleKeyDown = (event: React.KeyboardEvent<HTMLElement>) => {
      if (_opened) {
        const elements = Array.from(
          dropdownElement.querySelectorAll<HTMLButtonElement>('.pattern-Menu-item')
        );
