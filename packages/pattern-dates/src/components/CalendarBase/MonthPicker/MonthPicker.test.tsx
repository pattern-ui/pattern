...
const ACTIVE_CONTROL_SELECTOR = '.pattern-MonthPicker-monthPickerControlActive';
const LEVEL_SELECTOR = '.pattern-MonthPicker-calendarHeaderLevel';
const HEADER_CONTROL_SELECTOR = '.pattern-MonthPicker-calendarHeaderControl';
