...
export const SPOTLIGHT_EVENTS = {
  open: 'pattern:open-spotlight',
  close: 'pattern:close-spotlight',
  toggle: 'pattern:toggle-spotlight',
  triggerAction: 'pattern:trigger-spotlight-action',
  registerActions: 'pattern:register-spotlight-actions',
  removeActions: 'pattern:remove-spotlight-actions',
} as const;
