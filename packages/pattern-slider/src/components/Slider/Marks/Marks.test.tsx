...
describe('@pattern-ui/core/Slider/Marks', () => {
  it('renders correct marks labels', () => {
    ...
    expect(container.querySelectorAll('.pattern-Slider-markWrapper')).toHaveLength(2);
  ...
  it('calls onChange with mark value when mark label is pressed', () => {
    ...
    userEvent.click(container.querySelectorAll('.pattern-Slider-markLabel')[0]);
    expect(spy).toHaveBeenLastCalledWith(50);
    userEvent.click(container.querySelectorAll('.pattern-Slider-markLabel')[1]);
  ...
  it('sets mark left property based on mark value', () => {
    ...
    const marks = container.querySelectorAll('.pattern-Slider-markWrapper');
