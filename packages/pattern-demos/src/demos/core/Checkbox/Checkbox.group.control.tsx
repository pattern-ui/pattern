...
import { CheckboxGroup, CheckboxGroupProps, Checkbox } from '@pattern-ui/core';

const codeTemplate = (props: string) => `
import { CheckboxGroup, Checkbox } from '@pattern-ui/core';
...
export const groupControl: PatternControlDemo = {
  type: 'control',
  component: Wrapper,
  codeTemplate,
