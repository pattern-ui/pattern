...
export interface DrawerProps
  extends Omit<DefaultProps<DrawerStylesNames>, PatternStyleSystemSize>,
...
const transitions: Record<DrawerPosition, PatternTransition> = {
  top: 'slide-down',
  bottom: 'slide-up',
  left: 'slide-right',
  right: 'slide-left',
...
const rtlTransitions: Record<DrawerPosition, PatternTransition> = {
  top: 'slide-down',
  bottom: 'slide-up',
  right: 'slide-right',
  left: 'slide-left',
...
export function Drawer(props: DrawerProps) {
  const {
    ...
    overlayBlur,
    ...others
  } = usePatternDefaultProps('Drawer', defaultProps, props);
          ...
          >
            <Paper<'div'>
              ...
              onKeyDownCapture={(event) => {
                const shouldTrigger =
                  (event.target as any)?.getAttribute('data-pattern-stop-propagation') !== 'true';
