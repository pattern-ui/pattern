...
const queries = {
  getLabel: (container: HTMLElement) => container.querySelector('.pattern-InputWrapper-label'),
  getError: (container: HTMLElement) => container.querySelector('.pattern-InputWrapper-error'),
  getRequired: (container: HTMLElement) =>
    container.querySelector('.pattern-InputWrapper-required'),
